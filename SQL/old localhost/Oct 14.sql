...
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateAccountWithRollback` ()   BEGIN
  ...
  INSERT INTO tblcustomeraccount VALUES('aaaaaaaaaa#510','aaaaaaaaaa','ar4ygj44');
  
  INSERT INTO tblcustomerinformation VALUES('aaaaaaaaaa#510','Altes','Bryan Ken','S','Del Rosatio st. Brgy Kalayaan Angono Rizal Kalayaan Angono, Rizal','09158350780','KBN','0','bryanken01230@gmail.com','');
