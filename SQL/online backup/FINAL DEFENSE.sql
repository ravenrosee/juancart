...
--
-- Host: localhost:3306
-- Generation Time: Nov 23, 2023 at 09:11 AM
...
(27, 'Carson', 'It', 'Waller', '09123456789', 'yedat23115@marksia.com', 'SOCCSKSARGEN', 'South Cotabato', 'Surallah', 'Talahik', 'Sunt iste cum ea do', '2000', '', 'pending'),
(28, 'Armand', 'Er', 'French', '09123456789', 'bryanken01230@gmail.com', 'BARMM', 'Basilan', 'Tuburan', 'Bohetambis', 'Porro error eius con', '1000', 'Brand X', 'pending');
...
(15, 'gel-toner-radiantGlow.png', 'Gel Toner', 100, '60ml', 10074, 26, 'Glass Skin', NULL, NULL, NULL),
...
(20, 'alcohol.png', 'Isopropyl Alcohol', 50, '1 Liter', 6499, 3701, 'Alcohol', NULL, NULL, NULL),
...
--
-- Dumping data for table `tblverificationcode`
--

INSERT INTO `tblverificationcode` (`verificationID`, `Email`, `verificationcode`, `Expiration`) VALUES
(15, 'ravenroseberenguila_12', 'RSDZ', '2023-11-23 02:31:01'),
(16, 'ravenberenguila', 'DEYS', '2023-11-23 02:39:34'),
(17, 'yedat23115', 'CFSV', '2023-11-23 08:39:43'),
(18, 'bryanken01230', 'LVCY', '2023-11-23 08:42:25');
...
--
ALTER TABLE `tblprocedurestorage`
  MODIFY `procedureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
...
--
ALTER TABLE `tblverificationcode`
  MODIFY `verificationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
