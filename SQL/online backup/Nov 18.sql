...
--
-- Host: localhost:3306
-- Generation Time: Nov 18, 2023 at 10:10 AM
...
(3, '-1000', 0, 'test', 2000, 0, 0, 0, '2023-11-15 00:00:00', 'test', 'test', 'test', 'test');
...
--
ALTER TABLE `tblordercheckout`
  MODIFY `OrderNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
