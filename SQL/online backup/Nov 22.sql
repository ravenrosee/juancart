...
INSERT INTO tblcourierdelivery(OrderRefNumber,courierID) VALUES('ref64','CourierID2');
INSERT INTO tblcourierdeliverydate(OrderRefNumber, DeliveryDate) VALUES('ref64','2023-11-22 17:28:35');
UPDATE tblorderstatus SET Status = 'Delivery' WHERE OrderRefNumber = 'ref64';
...
--
ALTER TABLE `tblcourierdelivery`
  MODIFY `deliveryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
...
--
ALTER TABLE `tblordercheckout`
  MODIFY `OrderNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
