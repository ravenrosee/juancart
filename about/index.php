            ...
            <div class="abt-grid">
                ...
                <div class="abt-grid-item">
                    ...
                    <div class="abt-item2">
                        ...
                        <p class="abt-item-title">Juan Cart</p>

                        <p class="abt-item-info">Both small business owners from Taytay Tiangge and local clothing brands can now take advantage of this platform to showcase and sell their products to a broader audience. The website will curate the product listings to ensure they are attractive to customers. </p>
